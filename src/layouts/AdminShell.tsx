...
import { LayoutDashboard, Building2, Users, ShieldAlert, LogOut, Menu, Sparkles, LifeBuoy } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/workspace", label: "Client Workspace", icon: LifeBuoy },
