...
export default function Terms() {
  return (
    <div className="min-h-screen bg-gradient-dark text-foreground">
      <SEO title="Terms of Service — FastTract" description="Terms governing your use of FastTract, operated by Lynchmarc LLC, with payments processed by Stripe." path="/legal/terms" />
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 prose prose-invert">
        ...
        <p>Subscriptions are sold by Lynchmarc LLC. Payments and billing are processed by Stripe, Inc. We handle all customer service inquiries and refund requests directly.</p>
        <p>Plans include a 7-day free trial; your payment method is charged when the trial ends unless you cancel. Subscription fees, billing cycles, renewals, cancellations, and taxes are billed monthly in advance. Cancelling a subscription stops future renewals; you retain access until the end of the current paid period. Upgrades and downgrades take effect immediately.</p>
