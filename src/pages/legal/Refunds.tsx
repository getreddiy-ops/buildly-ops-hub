...
export default function Refunds() {
  return (
    <div className="min-h-screen bg-gradient-dark text-foreground">
      <SEO title="Refund Policy — FastTract" description="FastTract offers a 30-day money-back guarantee. Learn how to request a refund from Lynchmarc LLC." path="/legal/refunds" />
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 prose prose-invert">
        ...
        <p>Refunds are issued by Lynchmarc LLC through our payment processor, Stripe. To request a refund:</p>
        <ul className="list-disc pl-6">
          <li>Email <a href="mailto:getreddiy@gmail.com" className="text-primary">getreddiy@gmail.com</a> with the account email and purchase date.</li>
        </ul>

        <h2 className="mt-8 text-2xl font-semibold">Additional Information</h2>
        <p>Approved refunds are returned to the original payment method. Processing time depends on the card issuer. Cancelling your subscription stops future renewal charges; you will retain access to paid features until the end of the current billing period.</p>
