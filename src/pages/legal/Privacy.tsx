...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-gradient-dark text-foreground">
      <SEO title="Privacy Policy — FastTract" description="How FastTract, operated by Lynchmarc LLC, collects, uses, shares, and retains personal data, including Stripe payment processing." path="/legal/privacy" />
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 prose prose-invert">
        ...
        <ul className="list-disc pl-6">
          <li><strong>Stripe</strong> — our payment processor for subscriptions, billing, and payment-method management.</li>
